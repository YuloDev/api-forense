...
"""
Test del endpoint validar_imagen con validación SRI en prioritarias
"""
...
def test_endpoint_prioritarias_sri():
    """Test del endpoint validar_imagen con SRI en prioritarias"""
    print("🔬 TEST ENDPOINT CON SRI EN PRIORITARIAS")
    print("=" * 60)
...
if __name__ == "__main__":
    test_endpoint_prioritarias_sri()
